package com.crossover.trial.rest.helpers;
...
public interface WeatherCollectorEndpoint {
     ...
     * @param pointType the point type, {@link emDataPointType} for a complete list
...
//    @Produces(MediaType.APPLICATION_JSON)
     ...
     * @return an HTTP Response with a json representation of {@link com.crossover.trial.airport.context.AirportData}
     */
    @GET
    @Path("/airport/{iata}")
    @Produces(MediaType.APPLICATION_JSON)
...
//    @Produces(MediaType.APPLICATION_JSON)
    ...
    /**
     * Add a new airport to the known airport list.
     * @param airportDataJson AirportData string json type
     * @return HTTP Response code for the add operation
     */
    @POST
    @Path("/airport")
